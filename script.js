...
const galleryFloors = {
  ...
  2: [
    { src: "assets/gallery-2f-01.jpg", caption: "진료실" },
    { src: "assets/gallery-2f-02.jpg", caption: "진료실" },
    { src: "assets/gallery-2f-03.jpg", caption: "진료실" },
    { src: "assets/gallery-2f-04.jpg", caption: "회복관리실" },
    { src: "assets/gallery-2f-05.jpg", caption: "회복관리실" },
    { src: "assets/gallery-2f-06.jpg", caption: "회복관리실" },
    { src: "assets/gallery-2f-07.jpg", caption: "회복관리실" },
    { src: "assets/gallery-2f-08.jpg", caption: "회복관리실 - 수치료기" },
    { src: "assets/gallery-2f-09.jpg", caption: "회복관리실 - 세라젬" },
    { src: "assets/gallery-2f-10.jpg", caption: "회복관리실 - 반신욕" },
    { src: "assets/gallery-2f-11.jpg", caption: "회복관리실 - 힐링베드, 롤링베드" },
    { src: "assets/gallery-2f-12.jpg", caption: "회복관리실" },
    { src: "assets/gallery-2f-13.jpg", caption: "회복관리실 - 황금다리" },
    { src: "assets/gallery-2f-14.jpg", caption: "회복관리실 - 황토파라핀" },
...
function closeScheduleModal() {
  ...
  const isAnyModalOpen = (modal && !modal.hidden) || (careModal && !careModal.hidden) || (adminModal && !adminModal.hidden) || (yakchimModal && !yakchimModal.hidden) || (hanyakModal && !hanyakModal.hidden) || (lindaModal && !lindaModal.hidden);
  if (!isAnyModalOpen) {
...
function renderCareModalContent() {
  ...
  if (careModalDetailBtnWrapper) {
    const hasDetail = ["yakchim-card", "hanyak-card", "linda-card", "gongjin-card", "care-spine-card", "care-joint-card", "care-accident-card", "care-sports-card", "care-diet-card", "care-digestion-card"].includes(activeCareCard?.id);
...
function closeDoctorModal() {
  ...
  const isAnyModalOpen = (scheduleModal && !scheduleModal.hidden) || (careModal && !careModal.hidden) || (adminModal && !adminModal.hidden) || (yakchimModal && !yakchimModal.hidden) || (hanyakModal && !hanyakModal.hidden) || (lindaModal && !lindaModal.hidden);
  if (!isAnyModalOpen) {
    document.body.classList.remove("modal-open");
  }
  modalImage.src = "";
...
careCards.forEach((card) => {
  card.addEventListener("click", () => {
    ...
    if (card.id === "care-joint-card" && window.innerWidth > 768) {
    ...
    if (card.id === "care-sports-card" && window.innerWidth > 768) {
      location.href = "care-sports.html";
      return;
    }
    if (card.id === "care-diet-card" && window.innerWidth > 768) {
      location.href = "care-diet.html";
      return;
    }
    if (card.id === "care-digestion-card" && window.innerWidth > 768) {
      location.href = "care-digestion.html";
      return;
    }
    openCareModal(card);
  });
...
careModalDetailBtn?.addEventListener("click", () => {
  ...
  // 척추/관절/교통사고/스포츠 독립 페이지로 이동 또는 상세 팝업 오픈
  if (cardId === "care-spine-card") {
    ...
    document.body.classList.remove("modal-open");
    location.href = "care-accident.html";
  } else if (cardId === "care-sports-card") {
    document.body.classList.remove("modal-open");
    location.href = "care-sports.html";
  } else if (cardId === "care-diet-card") {
    document.body.classList.remove("modal-open");
    location.href = "care-diet.html";
  } else if (cardId === "care-digestion-card") {
    document.body.classList.remove("modal-open");
    location.href = "care-digestion.html";
