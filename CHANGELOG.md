...
- 작업 ID: AEO-005
  - 변경: [AEO-005] 개인정보처리방침 링크 클릭 시 새 탭이나 페이지 전환 대신 독립된 새 팝업 창(window.open)으로 뜨도록 변경하고, 해당 서브페이지 내 돌아가기 버튼을 창 닫기 기능으로 개선했습니다.
  - 검증: onclick="window.open" 작동성 및 창 닫기 스크립트 수동 검증 완료
  - 배포 commit: (main 병합 시 확정)

### 수정

## 2026-08-25 — 홈페이지 FAQ, FAQPage JSON-LD 및 개인정보처리방침 독립 URL 적용 완료
...
- 작업 ID: AEO-005
  - 변경: [AEO-005] 의료법 및 개인정보보호법에 준하는 개인정보처리방침 독립 페이지(privacy.html)를 구축하고 홈페이지 푸터에 링크를 연동했습니다.
  - 검증: privacy.html 단독 가독성 및 푸터 내 경로 연동 상태 수동 검증 완료
  - 배포 commit: be25bed4babe0d3de3ab097296db4894ef98006a
