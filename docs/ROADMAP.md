# 부부한의원 홈페이지 SEO/AEO 개선 로드맵

## 운영 원칙

- 한 번에 하나의 작은 작업을 완료한다.
- 각 작업은 독립적으로 검증하고 되돌릴 수 있어야 한다.
- 상태는 GitHub Issue와 Pull Request를 기준으로 관리한다.

## Phase 0 — 안전장치 및 기준선

- [x] OPS-001 저장소 협업 문서 적용
- [x] OPS-002 현재 배포 방식 문서화
- [x] OPS-003 운영 사이트 백업 및 복구 절차 확인
- [x] SEO-000 초기 SEO/AEO 기준선 저장
...
- [x] SEO-008 카카오톡·문자·SNS 공유 화면 검수
...
- [x] CONTENT-001 척추 진료 독립 페이지
- [x] CONTENT-002 관절 진료 독립 페이지
- [x] CONTENT-003 교통사고 진료 독립 페이지
- [x] CONTENT-004 다이어트 독립 페이지
- [x] CONTENT-005-digestion 소화 및 순환장애 독립 페이지
- [x] CONTENT-005-women-children 여성 및 소아 독립 페이지
- [x] CONTENT-005-autonomic 자율신경실조 독립 페이지
- [x] CONTENT-005 약침·추나·침도 치료 페이지 (건너뜀 — 진료 분야만 상세 페이지 개설 원칙)
- [x] CONTENT-006 의료진별 독립 페이지 (건너뜀 — 진료 분야만 상세 페이지 개설 원칙)
- [x] CONTENT-007 페이지 간 내부 링크 구조

## Phase 4 — 로컬 SEO·예약

- [x] LOCAL-001 홈페이지 NAP 확정
- [x] LOCAL-002 Google 비즈니스 프로필 확인·정비 (가이드라인 수립 및 검수)
- [x] LOCAL-003 네이버 플레이스 수동 확인·정비 (가이드라인 수립 및 검수)
- [x] LOCAL-004 카카오맵 정보 정합성 확인 (가이드라인 수립 및 검수)
- [ ] LOCAL-005 공개 예약·상담 허브 구축
- [ ] LOCAL-006 예약 링크 UTM 및 전환 측정
